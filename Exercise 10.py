...
# to do without using sets that I had not yet discussed on the blog,
...
a=random.sample(range(1,50),random.randint(1,30))
print('First list of length {} : '.format(len(a)))
print(a)

b=random.sample(range(1,50),random.randint(1,30))
print('Second list of length {} : '.format(len(b)))
print(b)

li=list(set(filter(lambda x:x in b,a)))
print("List of common elements : ")
print(li)
print("Common elements count : {}".format(len(li)))
